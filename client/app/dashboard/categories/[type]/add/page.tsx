...
export default function AddCategoryPage() {
  ...
  if (!categoryType) {
    return (
      <div className="py-4">
        <div className="alert alert-warning">Invalid category type.</div>
  ...
  return (
    <div className="py-4">
      <div className="section-header mb-4">
        ...
        <h2 className="fw-semibold mb-0 h3">Add {title.slice(0, -1)}</h2>
      ...
      <CategoryForm mode="create" categoryType={categoryType} onSuccess={onSuccess} />
    </div>
  );
}
